namespace Edwetl
{
    partial class ddgl_ddck
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.richTextBox1.Text = "Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=103.160.120.1" +
                "73)(PORT=1521)))(CONNECT_DATA=(SERVICE_NAME=cmm1)));User ID=cust_dm;Password=cus" +
                "t_dm";
            // 
            // button1
            // 
