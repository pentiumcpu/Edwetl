...
namespace Edwetl
{
    public partial class Form_ywtj : Form
    {
        public Form_ywtj()
        {
            InitializeComponent();
        ...
        private void btn_sxt_excel(object o, EventArgs e)
        {
            ...
            string str_des = path + "调度历史时序图_" + str_now + ".xlsx";
            ...
            if (str_filename.Length > 2)
            {
                ...
                {
                    create_sxt_excel(str_src, str_des);
                    write_sxt_excel(str_des);
                }
            }
        }
        private void create_sxt_excel(string src, string des)
        {
        ...
        private void write_sxt_excel(string file_name)
        {
            string str_filename = textBox1.Text;
            if (str_filename.Length > 0)
            {
                ...
                {
                    sxt_excel se = new sxt_excel(str_filename, file_name);
                    se.write_sxt_excel();
                }
            }
            else
